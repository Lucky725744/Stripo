...
/* added by me START*/
    ...
    function hide(){
      ...
      document.querySelector('.esdev-app .sripo-watermark').classList.add('hidden');
    };
    $(document).ready(function() {
      /*Taking id from Url Start*/
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status === 'success') {
                rawhtml=response.data.rawhtml;
                rawcss=response.data.rawcss;
            } else {
    ...
    setTimeout(hide, 3000);
      ...
      function loadDemoTemplate(callback) {
         setTimeout(function() {
            ...
            $('.stripo-watermark').addClass('hidden');
        }, 100);
      }
